...
export const Component = function Terms(): JSX.Element {
  ...
  return (
    <Container maxWidth="sm" sx={{ marginTop: (x) => x.spacing(3), marginBottom: (x) => x.spacing(3) }}>
      <Typography level="h1" gutterBottom>
        Terms of Service
      </Typography>
      <Typography gutterBottom>
        These Terms of Service govern your use of the website located at <Link href={appOrigin}>{appOrigin}</Link> and
        any related services provided by {appName}.
      </Typography>
      <Typography gutterBottom>
        By accessing <Link href={appOrigin}>{appOrigin}</Link>, you agree to abide by these Terms of Service and to
        comply with all applicable laws and regulations. If you do not agree with these Terms of Service, you are
        prohibited from using or accessing this website or using any other services provided by {appName}.
      </Typography>
      <Typography gutterBottom>
        We, {appName}, reserve the right to review and amend any of these Terms of Service at our sole discretion. Upon
        doing so, we will update this page. Any changes to these Terms of Service will take effect immediately from the
        date of publication.
      </Typography>
      <Typography gutterBottom>These Terms of Service were last updated on 28 February 2021.</Typography>
      ...
      <ol>
        ...
        <li>
          ...
          our networks or any other service {appName} provides;
        </li>
        <li>
      ...
      <Typography gutterBottom>
        The intellectual property in the materials contained in this website are owned by or licensed to {appName} and
      ...
      <Typography gutterBottom>
        ...
        you violate any of these restrictions or the Terms of Service, and may be terminated by {appName}
        at any time.
      </Typography>
      <Typography level="h2" gutterBottom>
        Liability
      ...
      <Typography gutterBottom>
        Our website and the materials on our website are provided on an &lsquo;as is&rsquo; basis. To the extent
        permitted by law, {appName} makes no warranties, expressed or implied, and hereby disclaims and negates all
        other warranties including, without limitation, implied warranties or conditions of merchantability, fitness for
        a particular purpose, or non-infringement of intellectual property, or other violation of rights.
      </Typography>
      <Typography gutterBottom>
        In no event shall {appName} or its suppliers be liable for any consequential loss suffered or incurred by you or
        any third party arising from the use or inability to use this website or the materials on this website, even if{' '}
        {appName} or an authorized representative has been notified, orally or in writing, of the possibility of such
        damage.
      </Typography>
      <Typography gutterBottom>
        In the context of this agreement, &ldquo;consequential loss&rdquo; includes any consequential loss, indirect
        loss, real or anticipated loss of profit, loss of benefit, loss of revenue, loss of business, loss of goodwill,
        loss of opportunity, loss of savings, loss of reputation, loss of use and/or loss or corruption of data, whether
      ...
      <Typography gutterBottom>
        ...
        {appName} does not warrant or make any representations concerning the accuracy, likely results, or reliability
      ...
      <Typography gutterBottom>
        {appName} has not reviewed all of the sites linked to its website and is not responsible for the contents of any
        such linked site. The inclusion of any link does not imply endorsement, approval, or control by
        {appName} of the site. Use of any such linked site is at your own risk and we strongly advise you make your own
      ...
      <Typography gutterBottom>
        These Terms of Service are governed by and construed in accordance with the laws of United States. You
