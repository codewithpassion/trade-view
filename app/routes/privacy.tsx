  ...
  return (
    <Container sx={{ my: 3 }} maxWidth="sm">
      ...
      <Typography gutterBottom>
        Your privacy is important to us. It is {appName}&#39; policy to respect your privacy and comply with any
        applicable law and regulation regarding any personal information we may collect about you, including across our
        website, <Link href={appOrigin}>{appOrigin}</Link>, and other sites we own and operate.
      </Typography>
      <Typography gutterBottom>
